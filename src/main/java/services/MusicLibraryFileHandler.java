...
/**
 *
 * MusicLibraryFileHandler handles the persistence of the music library by
 * saving and loading music items to and from a CSV file.
 *
 * This class allows for: - Saving a list of MusicItem objects to a CSV file. -
...
public class MusicLibraryFileHandler {
     ...
     * @param filePath The name of the file (without extension). If empty, the
