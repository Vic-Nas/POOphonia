 ...
 *
 * This class initializes the music library, processes user commands, and
 * ensures the library is saved before exiting.
 *
 * The application follows a simple console-based interface where commands are
 * executed from an input file.
 *
